...
EnemyTank::EnemyTank(Vector2 position) :EnemyEntity(ENTITY_ENEMY_TANK)
{
...
void EnemyTank::EnemyUpdate(float deltaSeconds, Vector2 playerPosition, bool hasLineOfSight)
{
...
const void EnemyTank::Render(Vector2& scale)
{
